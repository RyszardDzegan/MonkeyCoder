...
namespace MonkeyCoder.Functions.Tests
{
    ...
    public class SingleFunctionInvokerWithMandatoryArgumentTests
    {
        ...
        {
            new SingleFunctionInvokerWithMandatoryArgument(null, null, null);
        }
        ...
        public void Throws_exception_when_possible_arguments_are_null()
        {
            ...
            new SingleFunctionInvokerWithMandatoryArgument(function, null, null);
        }
        ...
        public void Works_with_empty_action_and_1_string_mandatory_argument()
        {
            ...
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[0], "x");
        ...
        {
            var function = new Action<int>(x => { });
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { null, null }, "x");
            var e = sut.GetEnumerator();
            IsFalse(e.MoveNext());
        }
        ...
        public void Works_with_1_nullable_int_action_and_2_null_possible_arguments_and_1_int_mandatory_argument()
        {
            var result = "";
            var function = new Action<int?>(x => { result = Convert.ToString(x); });
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { null, null }, 1);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            e.Current.DynamicInvoke();
            AreEqual("1", result);
        ...
        public void Works_with_1_string_1_int_action_and_2_null_1_int_possible_arguments_and_1_string_mandatory_argument()
        {
            ...
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { null, null, 1 }, "x");
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            e.Current.DynamicInvoke();
            AreEqual("x1", result);
        ...
        public void Works_with_1_int_action_and_1_int_possible_argument_and_1_int_mandatory_argument()
        {
            ...
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1 }, 2);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            e.Current.DynamicInvoke();
            AreEqual(2, result);
        ...
        public void Works_with_1_int_action_and_2_int_possible_arguments_and_1_int_mandatory_argument()
        {
            var result = -1;
            var function = new Action<int>(x => { result = x; });
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, 2 }, 3);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            e.Current.DynamicInvoke();
            AreEqual(3, result);
        ...
        public void Works_with_1_int_action_and_2_int_1_string_possible_arguments_and_1_int_mandatory_argument()
        {
            object result = -1;
            var function = new Action<int>(x => { result = x; });
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, 2, "a" }, 3);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            e.Current.DynamicInvoke();
            AreEqual(3, result);
        ...
        {
            var function = new Func<int, int>(x => x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[0], 1);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
        ...
        public void Works_with_2_string_func_and_2_string_possible_arguments_and_1_int_mandatory_argument()
        {
            ...
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { "a", "b" }, 1);
            var e = sut.GetEnumerator();
            IsFalse(e.MoveNext());
        }
        ...
        {
            var function = new Func<string, string, string>((x, y) => x + y);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { "a", "b" }, "x");
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { "a" }, 1);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, "a" }, 2);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, "a" }, "x");
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, 2, "a" }, "x");
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            AreEqual("x1", e.Current.DynamicInvoke());
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, "a", "b" }, 2);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            AreEqual("a2", e.Current.DynamicInvoke());
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, "a", "b" }, "x");
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            AreEqual("x1", e.Current.DynamicInvoke());
            IsFalse(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, 2, "a", "b" }, 3);
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            AreEqual("a3", e.Current.DynamicInvoke());
            IsTrue(e.MoveNext());
        ...
        {
            var function = new Func<int, string, string>((x, y) => y + x);
            var sut = new SingleFunctionInvokerWithMandatoryArgument(function, new object[] { 1, 2, "a", "b" }, "x");
            var e = sut.GetEnumerator();
            IsTrue(e.MoveNext());
            AreEqual("x1", e.Current.DynamicInvoke());
            IsTrue(e.MoveNext());
